 ...
 *6)emptycol         */
static const char *colors[] = {"#131313","#252525","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
...
static const uint8_t borders[] = {0,5,5,4};
...
///--Menus and Programs---///
static const char *menucmd[] = { "dmenu_run", "-b","-p", "MENU", "-fn", "-gmnbox-gmnterm-medium-r-normal--10-110-75-75-p-50-iso8859-1", "-nf", "#D0D3D1", "-nb", "#1C1F22", "-sf", "#000000", "-sb", "#D0D3D1", NULL };
